...
import frc.robot.commands.HighGoalShot;
import frc.robot.commands.JoystickDrive;
import frc.robot.commands.JoystickShooter;
import frc.robot.commands.LowGoalShot;
import frc.robot.commands.RunSerializer;
...
// Driver Buttons
  ...
  private void configureBindings() {
    ...
    lowShotButton.onTrue(new LowGoalShot());

    highShotButton.onTrue(new HighGoalShot());
  }
